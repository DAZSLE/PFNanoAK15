...
--customise PhysicsTools/AK15Nano/addAK15_cff.setupAK15Nano_mc  $NO_EXEC $PARALLEL 
...
--customise PhysicsTools/AK15Nano/addAK15_cff.setupAK15Nano_data  $NO_EXEC $PARALLEL
