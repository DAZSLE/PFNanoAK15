...
def setupAK15(process, runOnMC=False, path=None, runParticleNet=False, runParticleNetMD=False):
    ...
    if runParticleNet:
        ...
        from PhysicsTools.PFNanoAK15.pfParticleNetPreprocessParamsAK15_cfi import pfParticleNetPreprocessParamsAK15
    ...
    if runParticleNetMD:
        process.pfParticleNetTagInfosAK15.jet_radius = 1.5
        from PhysicsTools.PFNanoAK15.pfMassDecorrelatedParticleNetPreprocessParamsAK15_cfi import pfMassDecorrelatedParticleNetPreprocessParamsAK15
        # FIXME
